...
#ideal dose
opt_dose_ideal_dose, opt_effect_ideal_dose = steepest_ascent(ideal_dose, x0 = 1.0)
print(f"Steepest Ascent Method - Optimal Ideal Dose: {opt_dose_ideal_dose: .2f} mg")
print(f"Steepest Ascent Method - Optimal Ideal Dose Effect: {opt_effect_ideal_dose*100: .2f}%")
